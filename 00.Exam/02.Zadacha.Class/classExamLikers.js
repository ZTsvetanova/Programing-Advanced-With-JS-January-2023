...
//функция, която принтира коментарите и отговорите сортирани
toString(sortType) {
    let result = [];
